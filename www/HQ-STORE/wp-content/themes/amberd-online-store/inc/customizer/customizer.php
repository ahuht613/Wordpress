...
function amberd_customize_register( $wp_customize ) {
	...
	if ( class_exists( 'WooCommerce' ) ) {
        require get_template_directory() . '/inc/customizer/sections/woocommerce-amberd-customizer.php';
    };
}

add_action( 'customize_register', 'amberd_customize_register' );