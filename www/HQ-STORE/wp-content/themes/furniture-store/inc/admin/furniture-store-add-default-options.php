...
add_action('after_switch_theme', 'register_furniture_store_amberd_theme_default_options_once');

function register_furniture_store_amberd_theme_default_options_once () {
	...
	$default = sanitize_hex_color('#f8f6ff');
    ...
    $default = amberd_text_sanitization('amberd_third_button_slide third_btn_slide_right');
    ...
    $default = sanitize_hex_color('#f2f2f2');
    ...
    $default = amberd_text_sanitization('headerlayouttwo');
    ...
    $default = amberd_text_sanitization('Your relaxation and comfort depend on your interior...');
    ...
    $default = amberd_text_sanitization('Best Furniture Store!');
