( function( $, api ) {
    ...
    api.sectionConstructor['amberd-buy-premium-child'] = api.Section.extend( {
...
jQuery( document ).ready(function($) {
	...
	$('.multi-image-checkbox').on('change', function () {
	  amberdGetAllImageCheckboxes($(this).parent().parent());
	});
	function amberdGetAllImageCheckboxes($element) {
