<footer class="<?php 
            ...
            <div class="amberd-footer-copyright-text">
                ...
                $amberdFooterWP = sprintf( esc_html__( ' %s Powered by WordPress.', 'furniture-store' ), '<a target="_blank" title="WordPress Furniture Store Theme" href="'. esc_url( 'https://wordpress.org/themes/furniture-store' ) .'">Furniture Store</a> Theme.' );
                ?>
