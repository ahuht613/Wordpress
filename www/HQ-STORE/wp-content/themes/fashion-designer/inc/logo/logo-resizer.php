...
function fashion_designer_logo_customize_register( $wp_customize ) {
	...
	$wp_customize->add_setting('fashion_designer_logo_width',array(
		'default'=> '',
		'sanitize_callback'	=> 'sanitize_text_field'
		));
	$wp_customize->add_control('fashion_designer_logo_width',array(
		'label'	=> __('Logo Width','fashion-designer'),
	...
	$wp_customize->add_setting('fashion_designer_logo_height',array(
		'default'=> '',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('fashion_designer_logo_height',array(
		'label'	=> __('Logo Height','fashion-designer'),
		'description'	=> __('Enter a value in pixels. Example:20px','fashion-designer'),
		'input_attrs' => array(
    	'placeholder' => __( '10px', 'fashion-designer' ),),
		'section'=> 'title_tagline',
	...
	$wp_customize->add_setting('fashion_designer_logo_padding',array(
		'default'=> '',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('fashion_designer_logo_padding',array(
		'label'	=> __('Logo Padding','fashion-designer'),
		'description'	=> __('Enter a value in pixels. Example:20px','fashion-designer'),
		'input_attrs' => array(
      'placeholder' => __( '10px', 'fashion-designer' ),
    ),
	...
	$wp_customize->add_setting('fashion_designer_logo_margin',array(
		'default'=> '',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('fashion_designer_logo_margin',array(
		'label'	=> __('Logo Margin','fashion-designer'),
		'description'	=> __('Enter a value in pixels. Example:20px','fashion-designer'),
		'input_attrs' => array(
      'placeholder' => __( '10px', 'fashion-designer' ),
    ),
  ...
  $wp_customize->add_setting('fashion_designer_site_title_font_size',array(
		'default'=> '',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('fashion_designer_site_title_font_size',array(
		'label'	=> __('Site Title Font Size','fashion-designer'),
		'description'	=> __('Enter a value in pixels. Example:20px','fashion-designer'),
		'input_attrs' => array(
      'placeholder' => __( '10px', 'fashion-designer' ),
    ),
		'section'=> 'title_tagline',
		'type'=> 'text',
		'active_callback' => 'fashion_designer_logo_title_hide_show'
	));

	$wp_customize->add_setting('fashion_designer_site_title_color', array(
		'default'           => '#fff',
		'sanitize_callback' => 'sanitize_hex_color',
	));
	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'fashion_designer_site_title_color', array(
		'label'    => __('Site Title Color', 'fashion-designer'),
		'section'  => 'title_tagline',
		'active_callback' => 'fashion_designer_logo_title_hide_show'
	)));
  ...
  $wp_customize->add_setting('fashion_designer_site_tagline_font_size',array(
		'default'=> '',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('fashion_designer_site_tagline_font_size',array(
		'label'	=> __('Site Tagline Font Size','fashion-designer'),
		'description'	=> __('Enter a value in pixels. Example:20px','fashion-designer'),
		'input_attrs' => array(
      'placeholder' => __( '10px', 'fashion-designer' ),
    ),
		'section'=> 'title_tagline',
		'type'=> 'text',
		'active_callback' => 'fashion_designer_tagline_hide_show'
	));

	$wp_customize->add_setting('fashion_designer_site_tagline_color', array(
		'default'           => '#fff',
		'sanitize_callback' => 'sanitize_hex_color',
	));
	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'fashion_designer_site_tagline_color', array(
		'label'    => __('Site Tagline Color', 'fashion-designer'),
		'section'  => 'title_tagline',
		'active_callback' => 'fashion_designer_tagline_hide_show'
	)));
}
