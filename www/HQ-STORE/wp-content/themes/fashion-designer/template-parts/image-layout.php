        ...
        <div class="entry-attachment">
            ...
            <?php if ( has_excerpt() ) : ?>
                <div class="entry-caption">
                    <div class="entry-content"><p><?php $fashion_designer_excerpt = get_the_excerpt(); echo esc_html( fashion_designer_string_limit_words( $fashion_designer_excerpt, esc_attr(get_theme_mod('fashion_designer_excerpt_number','30')))); ?></p></div>
                </div>
            <?php endif; ?>
        </div>    
        <?php
