jQuery(document).ready(function($) {
    'use strict';
    var this_obj = fashion_designer_plugin_activate_plugin;
    ...
    $(document).on('click', '.fashion-designer-plugin-install', function(event) {
        ...
        wp.updates.installPlugin({
            ...
            success: function(data) {
                ...
                button.removeClass('button-secondary updating-message fashion-designer-plugin-install');
                button.addClass('button-primary fashion-designer-plugin-activate');
                button.trigger('click');
            },
            error: function(data) {
                jQuery('.fashion-designer-recommended-plugins .fashion-designer-activation-note').css('display','block');
    ...
    $(document).on('click', '.fashion-designer-plugin-activate', function(event) {
    ...
    jQuery('#lite_theme .ibtana-skip-btn').click(function(){
        ...
        jQuery('#lite_theme .fashion-designer-recommended-plugins').css('display','none');
    });

    jQuery('#block_pattern .ibtana-skip-btn').click(function(){
        var light_theme = jQuery(this).attr('get-start-tab-id');
        jQuery('.' + light_theme).css('display','block');
        jQuery('#block_pattern .fashion-designer-recommended-plugins').css('display','none');
    });
