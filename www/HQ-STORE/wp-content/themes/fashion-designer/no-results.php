...
<h2 class="entry-title"><?php echo esc_html(get_theme_mod('fashion_designer_no_results_page_title',__('Nothing Found','fashion-designer')));?></h2>
...
<?php if ( is_home() && current_user_can( 'publish_posts' ) ) : ?>
	...
	<p><?php echo esc_html(get_theme_mod('fashion_designer_no_results_page_content',__('Sorry, but nothing matched your search terms. Please try again with some different keywords.','fashion-designer')));?></p><br />
		<?php get_search_form(); ?>
	<?php else : ?>
