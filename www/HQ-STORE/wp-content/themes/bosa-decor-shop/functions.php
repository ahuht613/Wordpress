...
if ( ! function_exists( 'bosa_decor_shop_enqueue_styles' ) ) :
	/**
	 * @since Bosa Decor Shop 1.0.0
	 */
	function bosa_decor_shop_enqueue_styles() {
        require_once get_theme_file_path ( 'inc/wptt-webfont-loader.php');

		wp_enqueue_style( 'bosa-decor-shop-style-parent', get_template_directory_uri() . '/style.css',
			array(
				'bootstrap',
				'slick',
				'slicknav',
        ...
        wp_enqueue_style(
            'bosa-decor-shop-google-fonts-two',
        ...
        wp_enqueue_script( 'bosa-decor-shop-custom-woo', get_stylesheet_directory_uri() . '/assets/js/custom-woo.js', array( 'jquery' ), '1.0', true );

	}

endif;
add_action( 'wp_enqueue_scripts', 'bosa_decor_shop_enqueue_styles', 10 );

/**
* Registers menu location. 
* @since Bosa Decor Shop 1.0.0
*/
function bosa_decor_shop_menu_register(){
    register_nav_menu(
        'menu-4', esc_html__( 'Category Menu', 'bosa-decor-shop' )
    );
}
add_action( 'after_setup_theme', 'bosa_decor_shop_menu_register' );

/**
* Add cart link
* @since Bosa Decor Shop 1.0.0
*/
if ( !function_exists( 'bosa_decor_shop_cart_link' ) ) {
    function bosa_decor_shop_cart_link() {
        ?>	
...
* @since Bosa Decor Shop 1.0.0
*/
if ( !function_exists( 'bosa_decor_shop_header_cart' ) ) {
    function bosa_decor_shop_header_cart() {
        ?>
            <div class="header-cart">
                <div class="header-cart-block">
                    <div class="header-cart-inner">
                        <?php bosa_decor_shop_cart_link(); ?>
...
* @since Bosa Decor Shop 1.0.0
*/
if ( !function_exists( 'bosa_decor_shop_header_add_to_cart_fragment' ) ) {
    function bosa_decor_shop_header_add_to_cart_fragment( $fragments ) {
        ob_start();
        bosa_decor_shop_cart_link();
        $fragments['a.cart-contents'] = ob_get_clean();
        return $fragments;
    }
    add_filter( 'woocommerce_add_to_cart_fragments', 'bosa_decor_shop_header_add_to_cart_fragment' );
}
...
* @since Bosa Decor Shop 1.0.0
*/
if ( !function_exists( 'bosa_decor_shop_head_wishlist' ) ) {
    function bosa_decor_shop_head_wishlist() {
            ...
            <div class="header-wishlist">
                <a href="<?php echo esc_url( $wishlist_url ); ?>">
                    ...
                    <span class="info-tooltip">
                        <?php esc_html_e( 'Wishlist', 'bosa-decor-shop' ); ?>
                    </span>
                </a>
            </div>
            <?php
...
* @since Bosa Decor Shop 1.0.0
*/
if (!function_exists( 'bosa_decor_shop_head_compare' ) ) {
    function bosa_decor_shop_head_compare() {
        if ( function_exists( 'yith_woocompare_constructor' ) ) {
            ...
            <div class="header-compare">
                <a class="compare added" rel="nofollow" href="<?php echo esc_url( $yith_woocompare->obj->view_table_url() ); ?>">
                    ...
                    <span class="info-tooltip">
                        <?php esc_html_e( 'Compare', 'bosa-decor-shop' ); ?>
                    </span>
                </a>
            </div>
            <?php
...
* @since Bosa Decor Shop 1.0.0
*/
if ( !function_exists( 'bosa_decor_shop_my_account' ) ) {
    function bosa_decor_shop_my_account() {
            ...
            <div class="header-my-account">
                <div class="header-login"> 
                    <a href="<?php echo esc_url( get_permalink( get_option( 'woocommerce_myaccount_page_id' ) ) ); ?>">
                        ...
                        <span class="info-tooltip">
                            <?php esc_html_e( 'My Account', 'bosa-decor-shop' ); ?>
                        </span>
                    </a>
                </div>
            </div>
...
* @return array.
*/
function bosa_decor_shop_get_pages(){
...
* @since Bosa Decor Shop 1.0.0
*/
if( !function_exists( 'bosa_decor_shop_blog_advertisement_banner' ) ){
    function bosa_decor_shop_blog_advertisement_banner(){
...
if ( ! function_exists( 'bosa_decor_shop_grid_thumbnail_date' ) ) :
    /**
     * Prints HTML with meta information for the tags and comments.
     */
    function bosa_decor_shop_grid_thumbnail_date() {
                    ...
                    comments_popup_link(
                        sprintf(
                            wp_kses(
                                ...
                                __( 'Comment<span class="screen-reader-text"> on %s</span>', 'bosa-decor-shop' ),
                                array(
                                    'span' => array(
                                        'class' => array(),
                                    ),
...
if( !function_exists( 'bosa_get_intermediate_image_sizes' ) ){
    ...
    */
    function bosa_get_intermediate_image_sizes(){
        ...
        $data   = array(
            'full'          => esc_html__( 'Full Size', 'bosa-decor-shop' ),
            'large'         => esc_html__( 'Large Size', 'bosa-decor-shop' ),
            'medium'        => esc_html__( 'Medium Size', 'bosa-decor-shop' ),
            'medium_large'  => esc_html__( 'Medium Large Size', 'bosa-decor-shop' ),
            'thumbnail'     => esc_html__( 'Thumbnail Size', 'bosa-decor-shop' ),
            '1536x1536'     => esc_html__( '1536x1536 Size', 'bosa-decor-shop' ),
            '2048x2048'     => esc_html__( '2048x2048 Size', 'bosa-decor-shop' ),
            'bosa-1920-550' => esc_html__( '1920x550 Size', 'bosa-decor-shop' ),
            'bosa-1370-550' => esc_html__( '1370x550 Size', 'bosa-decor-shop' ),
            'bosa-590-310'  => esc_html__( '590x310 Size', 'bosa-decor-shop' ),
            'bosa-420-380'  => esc_html__( '420x380 Size', 'bosa-decor-shop' ),
            'bosa-420-300'  => esc_html__( '420x300 Size', 'bosa-decor-shop' ),
            'bosa-420-200'  => esc_html__( '420x200 Size', 'bosa-decor-shop' ),
            'bosa-290-150'  => esc_html__( '290x150 Size', 'bosa-decor-shop' ),
            'bosa-80-60'    => esc_html__( '80x60 Size', 'bosa-decor-shop' ),
        );
...
if( !function_exists( 'bosa_decor_shop_archive_post_layout_filter' ) ){
    /**
    ...
    * @return array
    */
    add_filter( 'bosa_archive_post_layout_filter', 'bosa_decor_shop_archive_post_layout_filter' );
    function bosa_decor_shop_archive_post_layout_filter( $post_layout ){
...
if( !function_exists( 'bosa_decor_shop_header_layout_filter' ) ){
    /**
    ...
    * @return array
    */
    add_filter( 'bosa_header_layout_filter', 'bosa_decor_shop_header_layout_filter' );
    function bosa_decor_shop_header_layout_filter( $header_layout ){
        $added_header = array(
...
if( !function_exists( 'bosa_decor_shop_footer_layout_filter' ) ){
    /**
    ...
    * @return array
    */
    add_filter( 'bosa_footer_layout_filter', 'bosa_decor_shop_footer_layout_filter' );
    function bosa_decor_shop_footer_layout_filter( $footer_layout ){
        $added_footer = array(
...
* @return array
*/
function bosa_decor_shop_get_product_categories(){
