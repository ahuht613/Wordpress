...
<div id="offcanvas-menu" class="offcanvas-menu-wrap">
	...
	<div class="offcanvas-menu-inner">
		<div class="offcanvas-menu-content">
			<?php if( get_theme_mod( 'header_layout', 'header_fifteen' ) == 'header_fifteen' ){ ?>
				            ...
				            <ul class="nav navbar-nav navbar-left">
				                <li class="menu-item menu-item-has-children">
				                    <a href="#">
				                        ...
				                        <?php esc_html_e( 'Categories', 'bosa-decor-shop' ); ?>
				                    </a>
				                    <?php
				                    wp_nav_menu(array(
				                        'container'      => '',
			...
			<?php if( !get_theme_mod( 'disable_secondary_menu', false ) ){ ?>
				<?php if( get_theme_mod( 'header_layout', 'header_fifteen' ) == 'header_three' || get_theme_mod( 'header_layout', 'header_fifteen' ) == 'header_fifteen' ){ ?>
			...
			if ( !get_theme_mod( 'disable_header_button', false ) && !get_theme_mod( 'disable_mobile_header_buttons', false ) ){
				if( get_theme_mod( 'header_layout', 'header_fifteen' ) == 'header_one' ){ 
		    	...
		    	if( get_theme_mod( 'header_layout', 'header_fifteen' ) == 'header_two' ){
		    ...
		    <?php if ( !get_theme_mod( 'disable_contact_detail', false ) && !get_theme_mod( 'disable_mobile_contact_details', false ) && ( get_theme_mod( 'contact_phone', '' )  || get_theme_mod( 'contact_email', '' )  || get_theme_mod( 'contact_address', '' ) ) ){ ?>
			    <?php if( get_theme_mod( 'header_layout', 'header_fifteen' ) == 'header_one' || get_theme_mod( 'header_layout', 'header_fifteen' ) == 'header_two' ){ ?>
					<div class="d-lg-none">
