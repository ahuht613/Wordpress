				...
				<div class="col-6 col-md-3">
					<?php if ( class_exists('WooCommerce' ) ) { ?>
					    <div class="header-right" >
					        <?php
					        if( !get_theme_mod( 'disable_woocommerce_compare', false ) ){bosa_decor_shop_head_compare();
					        }
					        if( !get_theme_mod( 'disable_woocommerce_wishlist', false ) ){bosa_decor_shop_head_wishlist();
					        }
					        if( !get_theme_mod( 'disable_woocommerce_account', false ) ){bosa_decor_shop_my_account();
					        }
					        if( !get_theme_mod( 'disable_woocommerce_cart', false ) ){bosa_decor_shop_header_cart();
					        }
					        ?>
					    </div>	
					<?php } ?>
			...
			<div class="row">
				<div class="col-lg-8 d-none d-lg-flex align-items-center">
					...
					<nav id="site-navigation" class="main-navigation d-none d-lg-flex">
						<button class="menu-toggle" aria-controls="primary-menu" aria-expanded="false"><?php esc_html_e( 'Primary Menu', 'bosa-decor-shop' ); ?></button>
