...
<div id="page" class="site">
	<a class="skip-link screen-reader-text" href="#content"><?php esc_html_e( 'Skip to content', 'bosa-decor-shop' ); ?></a>

	<?php if( get_theme_mod( 'header_layout', 'header_fifteen' ) == '' || get_theme_mod( 'header_layout', 'header_fifteen' ) == 'header_one' ){
		get_template_part( 'template-parts/header/header', 'one' );
	}elseif( get_theme_mod( 'header_layout', 'header_fifteen' ) == 'header_two' ){
		get_template_part( 'template-parts/header/header', 'two' );
	}elseif( get_theme_mod( 'header_layout', 'header_fifteen' ) == 'header_three' ) {
		get_template_part( 'template-parts/header/header', 'three' );
	}elseif( get_theme_mod( 'header_layout', 'header_fifteen' ) == 'header_fifteen' ) {
