...
?>
	...
	<div id="content" class="site-content">
		<div class="container">
			...
			<?php bosa_decor_shop_blog_advertisement_banner(); ?>
							...
							<?php
								if( !get_theme_mod( 'disable_pagination', false ) ):
									the_posts_pagination( array(
										...
										'next_text' => '<span>'.esc_html__( 'Next', 'bosa-decor-shop' ) .'</span><span class="screen-reader-text">' . esc_html__( 'Next page', 'bosa-decor-shop' ) . '</span>',
										'prev_text' => '<span>'.esc_html__( 'Prev', 'bosa-decor-shop' ) .'</span><span class="screen-reader-text">' . esc_html__( 'Previous page', 'bosa-decor-shop' ) . '</span>',
										'before_page_number' => '<span class="meta-nav screen-reader-text">' . esc_html__( 'Page', 'bosa-decor-shop' ) . ' </span>',
									));
								endif;
								wp_reset_postdata();
							?>
