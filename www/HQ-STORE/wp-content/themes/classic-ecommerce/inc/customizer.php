...
function classic_ecommerce_customize_register( $wp_customize ) {
	...
	$wp_customize->add_section('classic_ecommerce_one_cols_section',array(
		...
		'description'	=> __('<p class="sec-title">Manage Slider Section</p> Select Category from the Dropdowns for slider, Also use the given image dimension (1200 x 450).','classic-ecommerce'),
		'priority'	=> null,
		'panel' => 'classic_ecommerce_panel_area'
	));
