...
function digital_storefront_getpage_css($hook) {
	wp_enqueue_script( 'digital-storefront-admin-script', get_template_directory_uri() . '/inc/admin/js/digital-storefront-admin-notice-script.js', array( 'jquery' ) );
    wp_localize_script( 'digital-storefront-admin-script', 'digital_storefront_ajax_object',
...
define('DIGITAL_STOREFRONT_FREE_DOC',__('https://themagnifico.net/eard/wathiqa/digital-storefront-free-doc/','digital-storefront'));
}
