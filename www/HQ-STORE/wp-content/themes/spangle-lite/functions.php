...
function spangle_lite_setup() {		
	$GLOBALS['content_width'] = apply_filters( 'spangle_lite_content_width', 680 );	
...
define('SPANGLE_LITE_THEME_DOC',__('https://gracethemes.com/documentation/spangle-doc/#homepage-lite','spangle-lite'));
define('SPANGLE_LITE_PROTHEME_URL',__('https://gracethemes.com/themes/interior-design-wordpress-theme/','spangle-lite'));
define('SPANGLE_LITE_LIVE_DEMO',__('https://gracethemes.com/demo/spangle/','spangle-lite'));
 ...
 */
add_action( 'after_setup_theme', 'spangle_lite_setup_woocommerce_support' );
function spangle_lite_setup_woocommerce_support()   
{
 ...
 */
function spangle_lite_skip_link_focus_fix() {  
...
add_action( 'wp_print_footer_scripts', 'spangle_lite_skip_link_focus_fix' );