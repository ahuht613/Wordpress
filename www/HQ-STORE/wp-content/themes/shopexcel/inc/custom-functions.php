...
function shopexcel_admin_notice(){
    ...
    $dismissnonce   = wp_create_nonce( 'shopexcel_admin_notice' );
        ...
        <div class="welcome-message notice notice-info">
            <div class="notice-wrapper">
                <div class="notice-text">
                    ...
                    <p class="dismiss-link"><strong><a href="?shopexcel_admin_notice=1&_wpnonce=<?php echo esc_attr( $dismissnonce ); ?>"><?php esc_html_e( 'Dismiss', 'shopexcel' ); ?></a></strong></p>
                </div>
            </div>
        </div>
    <?php }
...
function shopexcel_update_admin_notice(){
    ...
    if ( isset( $_GET['shopexcel_admin_notice'] ) && $_GET['shopexcel_admin_notice'] = '1' && wp_verify_nonce( $_GET['_wpnonce'], 'shopexcel_admin_notice' )) {
