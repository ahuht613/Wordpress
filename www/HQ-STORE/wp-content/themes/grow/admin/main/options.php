...
function thinkup_customizer_theme_options( $wp_customize ) {
	...
	$wp_customize->add_section(
		new thinkup_customizer_customswitch_button_link(
			...
			array(
				'title'        => __( 'Need help?', 'grow' ),
				'priority'     => 1,
				'button_text'  => __( 'Hire a Developer', 'grow' ),
	...
	$wp_customize->add_control(
		new thinkup_customizer_customcontrol_upgrade(
			...
			array(
				...
				'price_discount'  => __( 'Upgrade Now (10% off)', 'grow' ),
				'price_normal'	  => __( 'Use coupon at checkout for 10% off.', 'grow' ),
				'coupon'	      => __( 'thinkup10', 'grow' ),
