...
<div class="wrapper-info">
    ...
    <div class="col-right">
		...
		<div class="update-now">
			<h4><?php esc_html_e('Buy VW Church at 20% Discount','vw-church'); ?></h4>
			...
			<div class="gutenberg-editor-tab" style="<?php echo esc_attr($vw_church_plugin_custom_css); ?>">
				<div class="block-pattern-img">
					...
					<p><?php esc_html_e('Follow the below instructions to setup Home page with Block Patterns.','vw-church'); ?></p>
	              	<p><b><?php esc_html_e('Click on Below Add new page button >> Click on "+" Icon.','vw-church'); ?></b></p>
				    ...
				    <p><b><?php esc_html_e('Click on Patterns Tab >> Click on Theme Name >> Click on Sections >> Publish.','vw-church'); ?></b></p>
		    ...
		    <div class="featurebox">
				...
				<div class="table-image">
					<table class="tablebox">
						...
						<tbody>
							<tr>
								<td><?php esc_html_e('Donation Page', 'vw-church'); ?></td>
							...
							<tr>
								...
								<td class="table-img"><?php esc_html_e('11', 'vw-church'); ?></td>
							</tr>
							<tr class="odd">
							...
							<tr>
								<td><?php esc_html_e('WordPress 6.4 or later', 'vw-church'); ?></td>
								<td class="table-img"><span class="dashicons dashicons-no"></span></td>
								<td class="table-img"><span class="dashicons dashicons-saved"></span></td>
							</tr>
							<tr class="odd">
								<td><?php esc_html_e('PHP 8.2 or 8.3', 'vw-church'); ?></td>
								<td class="table-img"><span class="dashicons dashicons-no"></span></td>
								<td class="table-img"><span class="dashicons dashicons-saved"></span></td>
							</tr>
							<tr>
								<td><?php esc_html_e('MySQL 5.6 (or greater) | MariaDB 10.0 (or greater)', 'vw-church'); ?></td>
								<td class="table-img"><span class="dashicons dashicons-no"></span></td>
								<td class="table-img"><span class="dashicons dashicons-saved"></span></td>
							</tr>
							<tr>
