...
class VW_Church_Fontawesome_Icon_Chooser extends WP_Customize_Control{
    public $type = 'icon';
    ...
    public function render_content(){ ?>
        <label>
            ...
            <div class="social-icon-search">
                <input class="socialInput" type="text" placeholder="<?php echo esc_attr_x( 'Icon', 'placeholder', 'vw-church' ); ?>">
            </div>
            ...
            <ul class="icon-list clearfix">
                <?php
                $vw_church_font_awesome_icon_array = vw_church_font_awesome_icon_array();
                foreach ($vw_church_font_awesome_icon_array as $vw_church_font_awesome_icon) {
                        $icon_class = $this->value() == $vw_church_font_awesome_icon ? 'icon-active' : '';
                        echo '<li class='.esc_attr($icon_class).'><i class="'.esc_attr($vw_church_font_awesome_icon).'"></i>
                        <span class="vw-church-social-class">'.esc_attr($vw_church_font_awesome_icon).'</span>
                        </li>';
                    }
                ?>
            </ul>
...
function vw_church_customizer_script() {
     
    wp_enqueue_style( 'font-awesome-1', esc_url(get_template_directory_uri()).'/assets/css/fontawesome-all.css');
    wp_enqueue_script( 'vw-church-customizer-script', esc_url(get_template_directory_uri()).'/assets/js/customizer-scripts.js', array("jquery"),'', true  );
}
add_action( 'customize_controls_enqueue_scripts', 'vw_church_customizer_script' );

if(!function_exists('vw_church_font_awesome_icon_array')){
    function vw_church_font_awesome_icon_array(){
