...
class VW_Church_About_Widget extends WP_Widget {
	function __construct() {
		parent::__construct(
			'VW_Church_About_Widget',
			__('VW About us', 'vw-church'),
			array( 'description' => __( 'Widget for about us section in sidebar', 'vw-church' ), ) 
		);
	}
	...
	?>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('author')); ?>"><?php esc_html_e('Author Name:','vw-church'); ?></label>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('designation')); ?>"><?php esc_html_e('Designation:','vw-church'); ?></label>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('description')); ?>"><?php esc_html_e('Description:','vw-church'); ?></label>
    	...
    	<p>
		<label for="<?php echo esc_attr($this->get_field_id('read_more_text')); ?>"><?php esc_html_e('Button Text:','vw-church'); ?></label>
		...
		<p>
		<label for="<?php echo esc_attr($this->get_field_id('read_more_url')); ?>"><?php esc_html_e('Button Url:','vw-church'); ?></label>
		...
		<p>
		<label for="<?php echo esc_attr($this->get_field_id( 'upload_image' )); ?>"><?php esc_html_e( 'Image Url:','vw-church'); ?></label>
		<?php
			if ( $upload_image != '' ) :
...
function vw_church_about_custom_load_widget() {
	register_widget( 'VW_Church_About_Widget' );
}
add_action( 'widgets_init', 'vw_church_about_custom_load_widget' );