...
if ( class_exists( 'WP_Customize_Control' ) ) {
	 ...
	 */
	class Shop_Hub_Toggle_Switch_Custom_Control extends WP_Customize_Control {
		/**
	 ...
	 */
	class Shop_Hub_Customize_Horizontal_Line extends WP_Customize_Control {
		/**
		 * Control Type.
		 */
		public $type = 'hr';
		...
		public function render_content() {
			?>
			<div>
				<span class="customize-line"></span>
			</div>
			<?php
		}
	}
...
if ( class_exists( 'WP_Customize_Section' ) ) {
	 ...
	 * Upsell section
	 */
	class Shop_Hub_Upsell_Section extends WP_Customize_Section {
		/**
		 * The type of control being rendered
		 */
		public $type = 'shop-hub-upsell';
		...
		protected function render() {
			...
			?>
			<li id="accordion-section-<?php echo esc_attr( $this->id ); ?>" class="shop_hub_upsell_section accordion-section control-section control-section-<?php echo esc_attr( $this->id ); ?> cannot-expand">
