    ...
    function buzzstore_credit() { ?>
        ...
        <span class="footer_copyright wow fadeInLeft" data-wow-delay="0.3s">
            <?php
                ...
                printf( ' WordPress Theme : by %1$s', '<span class="subfooter"><a href=" ' . esc_url('https://sparklewp.com/') . ' " rel="designer" target="_blank">'.esc_html__('Sparkle WP','buzzstore').'</a></span>' );
