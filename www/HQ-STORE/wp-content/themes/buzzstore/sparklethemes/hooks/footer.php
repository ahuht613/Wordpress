...
if ( ! function_exists( 'buzzstore_footer_widget_area' ) ) {
	function buzzstore_footer_widget_area(){ 
		...
		if(!empty( $top_footer_options ) && $top_footer_options =='enable' ) { 
			if( is_active_sidebar( 'buzzstorefooterone' ) || is_active_sidebar( 'buzzstorefootertwo' ) || is_active_sidebar( 'buzzstorefooterthree' ) || is_active_sidebar( 'buzzstorefooterfour' ) ):
			?>
