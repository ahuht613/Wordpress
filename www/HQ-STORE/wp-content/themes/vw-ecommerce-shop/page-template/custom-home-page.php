	...
	<div class="container">
		<div class="row m-0">
			...
			<div class="col-lg-9 col-md-8 padremove">
				<?php if( get_theme_mod( 'vw_ecommerce_shop_slider_hide_show', false) == 1 || get_theme_mod( 'vw_ecommerce_shop_resp_slider_hide_show', true) == 1) { ?>
				  	<section class="slider">
				  		<?php if(get_theme_mod('vw_ecommerce_shop_slider_type', 'Default slider') == 'Default slider' ){ ?>
					          ...
					          <div <?php if($i == 1){echo 'class="carousel-item active"';} else{ echo 'class="carousel-item"';}?>>
					            ...
					            <div class="carousel-caption">
					              <div class="inner_carousel">
					                ...
					                <?php if( get_theme_mod('vw_ecommerce_shop_slider_content_hide_show',true) == 1){ ?>
					                	<p class="wow slideInRight" data-wow-duration="2s"><?php $vw_ecommerce_shop_excerpt = get_the_excerpt(); echo esc_html( vw_ecommerce_shop_string_limit_words( $vw_ecommerce_shop_excerpt, esc_attr(get_theme_mod('vw_ecommerce_shop_slider_excerpt_number','30')))); ?></p>
					                <?php } ?>
					                <?php if( get_theme_mod('vw_ecommerce_shop_slider_button_text','Read More') != ''){ ?>
						                <div class="more-btn wow slideInRight" data-wow-duration="2s">            
						                  <a href="<?php echo esc_url(get_theme_mod('vw_ecommerce_shop_top_button_url',false));?>"><?php echo esc_html(get_theme_mod('vw_ecommerce_shop_slider_button_text',__('Read More','vw-ecommerce-shop')));?><span class="screen-reader-text"><?php echo esc_html(get_theme_mod('vw_ecommerce_shop_slider_button_text',__('Read More','vw-ecommerce-shop')));?></span></a>
						                </div>
						            <?php } ?>
					              </div>
					            </div>
				    	...
				    	<?php } else if(get_theme_mod('vw_ecommerce_shop_slider_type', 'Advance slider') == 'Advance slider'){?>
				          	<?php echo do_shortcode(get_theme_mod('vw_ecommerce_shop_advance_slider_shortcode')); ?>
				        <?php } ?>
				  	</section> 
				<?php }?>
			</div>
