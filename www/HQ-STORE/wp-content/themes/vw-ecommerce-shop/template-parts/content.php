...
<article id="post-<?php the_ID(); ?>" <?php post_class('inner-service'); ?>>
  <div class="post-main-box wow zoomInDown delay-1000" data-wow-duration="2s">
            ...
            <p>
              ...
              if($vw_ecommerce_shop_theme_lay == 'Excerpt'){ ?>
                <?php if(get_the_excerpt()) { ?>
                  <?php $vw_ecommerce_shop_excerpt = get_the_excerpt(); echo esc_html( vw_ecommerce_shop_string_limit_words( $vw_ecommerce_shop_excerpt, esc_attr(get_theme_mod('vw_ecommerce_shop_excerpt_number','30')))); ?> <?php echo esc_html(get_theme_mod('vw_ecommerce_shop_excerpt_suffix',''));?>
                <?php }?>
              <?php }?>   
            </p>
          </div>
        </div>
        <?php if( get_theme_mod('vw_ecommerce_shop_button_text', 'Read More') != ''){ ?>
    ...
    <?php }else if($vw_ecommerce_shop_theme_lay == 'Center'){ ?>
      <div class="new-text">
        <h2 class="section-title"><a href="<?php echo esc_url( get_permalink() ); ?>" title="<?php echo the_title_attribute(); ?>"><?php the_title();?><span class="screen-reader-text"><?php the_title(); ?></span></a></h2>
        <?php if( get_theme_mod( 'vw_ecommerce_shop_toggle_postdate',true) == 1 || get_theme_mod( 'vw_ecommerce_shop_toggle_author',true) == 1 || get_theme_mod( 'vw_ecommerce_shop_toggle_comments',true) == 1 || get_theme_mod( 'vw_ecommerce_shop_toggle_time',true) == 1) { ?>
          <div class="metabox">
