            ...
            <div class="col-lg-3 col-md-6 align-self-center social-icon text-lg-end text-center">
              <?php if( get_theme_mod('storefront_ecommerce_social_links') != ''){ ?>
                <?php if(get_theme_mod('storefront_ecommerce_facebook_url') != ''){ ?>
                  <a target="_blank" href="<?php echo esc_url(get_theme_mod('storefront_ecommerce_facebook_url')); ?>"><i class="fab fa-facebook-f"></i><span class="screen-reader-text"><?php echo esc_html('Facebook', 'storefront-ecommerce'); ?></span></a>
                <?php }?>
                <?php if(get_theme_mod('storefront_ecommerce_twitter_url') != ''){ ?>
                  <a target="_blank" href="<?php echo esc_url(get_theme_mod('storefront_ecommerce_twitter_url')); ?>"><i class="fab fa-twitter"></i><span class="screen-reader-text"><?php echo esc_html('Twitter', 'storefront-ecommerce'); ?></span></a>
                <?php }?>
                <?php if(get_theme_mod('storefront_ecommerce_instagram_url') != ''){ ?>
                  <a target="_blank" href="<?php echo esc_url(get_theme_mod('storefront_ecommerce_instagram_url')); ?>"><i class="fab fa-instagram"></i><span class="screen-reader-text"><?php echo esc_html('Instagram', 'storefront-ecommerce'); ?></span></a>
                <?php }?>
                <?php if(get_theme_mod('storefront_ecommerce_pinterest_url') != ''){ ?>
                  <a target="_blank" href="<?php echo esc_url(get_theme_mod('storefront_ecommerce_pinterest_url')); ?>"><i class="fab fa-pinterest-p"></i><span class="screen-reader-text"><?php echo esc_html('Pinterest', 'storefront-ecommerce'); ?></span></a>
                <?php }?>
              <?php }?>
            </div>
