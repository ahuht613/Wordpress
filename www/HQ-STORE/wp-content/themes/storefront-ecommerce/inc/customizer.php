...
function storefront_ecommerce_customize_register( $wp_customize ) {
   ...
   $wp_customize->add_control('storefront_ecommerce_site_logo_inline',array(
	...
	$wp_customize->add_control('storefront_ecommerce_slider_premium_info',array(
		...
		'description' => "<ul><li>You can change how many slides there are.</li><li>You can change the font family and the colours of headings and subheadings.</li><li>And so on...</li></ul><a target='_blank' href='". esc_url('https://www.buywptemplates.com/themes/storefront-ecommerce-wordpress-theme/') ." '>Upgrade to Pro</a>",
		'section'=> 'storefront_ecommerce_slider_section'
	));
	...
	$wp_customize->add_control('storefront_ecommerce_product_sec_premium_info',array(
		'type'=> 'hidden',
		'label'	=> __('Premium Features','storefront-ecommerce'),
		'description' => "<ul><li>Includes settings to set section title.</li><li>Contains settings for the background colour.</li><li>Contains options for background images.</li><li>You can change the font family and colours of heading.</li><li>And so on...</li></ul><a target='_blank' href='". esc_url('https://www.buywptemplates.com/themes/storefront-ecommerce-wordpress-theme/') ." '>Upgrade to Pro</a>",
		'section'=> 'storefront_ecommerce_product_section'
	));
